...
<section class="content-header">
    ...
    <div class="header-title">
        <h1>Declined</h1>
        <small>section for declined accounts</small>
    </div>
</section>
@endsection
                        ...
                        <ul class="dropdown-menu exp-drop" role="menu">
                            <li>
                                <a href="#" onclick="$('#dataTableExample1').tableExport({type:'json',escape:'false'});">
                                    <img src="{{asset('public/admin_assets/dist/img/json.png')}}" width="24" alt="logo">
                                    JSON</a>
                            </li>
                            <li>
                                <a href="#" onclick="$('#dataTableExample1').tableExport({type:'json',escape:'false',ignoreColumn:'[2,3]'});">
                                    <img src="{{asset('public/admin_assets/dist/img/json.png')}}" width="24" alt="logo"> JSON
                                    (ignoreColumn)</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="#" onclick="$('#dataTableExample1').tableExport({type:'doc',escape:'false'});">
                                    <img src="{{asset('public/admin_assets/dist/img/word.png')}}" width="24" alt="logo">
                                    Word</a>
                            </li>
                            <li>
                                <a href="#" onclick="$('#dataTableExample1').tableExport({type:'powerpoint',escape:'false'});">
                                    <img src="{{asset('public/admin_assets/dist/img/ppt.png')}}" width="24" alt="logo">
                                    PowerPoint</a>
                            </li>
                            <li class="divider"></li>
                            <li>
                    ...
                    <div class="table-responsive">
                        <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <img src="{{asset('public/admin_assets/dist/img/m2.png')}}" class="img-circle" alt="User Image" width="50" height="50">
                                    </td>
                                    <td>{{$declined->user->name}}</td>
                                    <td>
                                        @if ($declined->verification_type == 'team')
                                            <span class="label-warning label label-default">{{$declined->verification_type}}</span>                                        
                                        @elseif($declined->verification_type == 'player')
                                            <span class="label-success label label-default">{{$declined->verification_type}}</span>   
                                        @else
                                            <span class="label-danger label label-default">{{$declined->verification_type}}</span>   
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                    <button type="button" class="btn btn-add btn-sm" data-id="{{$declined->id}}" data-token="{{csrf_token()}}" id="viewVerificationBtn" data-toggle="modal" data-target="#view">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                        <button type="button" class="btn btn-add btn-sm" data-id="{{$declined->id}}" data-token="{{csrf_token()}}" id="editVerificationBtn" data-toggle="modal" data-target="#update">
                                            <i class="fa fa-pencil"></i>
                                        </button>
                                        <button type="button" data-id="{{$declined->id}}" data-token="{{csrf_token()}}" id="deleteVerificationBtn" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete">
