                    ...
                    <div class="table-responsive">
                        <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="{{ asset(extractFromImage($academic->academic_image_id)) }}" class="img-circle"
                                    ...
                                    <td>
                                        <button type="button" id="updateAcademic" class="btn btn-add btn-sm" data-id="{{$academic->id}}" data-token="{{ csrf_token() }}"
                                            data-toggle="modal" data-target="#customer1"><i class="fa fa-pencil"></i></button>
                                        <button type="button" id="deleteAcademic" class="btn btn-danger btn-sm" data-id="{{$academic->id}}" data-token="{{ csrf_token() }}"
    ...
    $(document).ready(function(){
        ...
        function newElement() {
            ...
            if (inputValue === '') {
               ...
               addPlayer(inputValue, academicId, token);  
            }
            removeSelOption(inputValue)   
        }

        function addPlayer(playerID, academicID, token){
            $.ajax({
                url:'/admin/academics/associate',
                type:'post',
                data:{'player':playerID, 'id':academicID, '_token': token},
                success: function(data) {
