                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8">
                            <div class="inbox-toolbar btn-toolbar">
                                <div class="btn-group">
                                    <a href="{{url('/admin/compose')}}" class="btn btn-add"> <span class="fa fa-pencil-square-o"></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="mailbox-sideber">
                                <div class="profile-usermenu">
                                    ...
                                    <ul class="nav">
                                        ...
                                        <li class="active">
                                            <a href="{{url('/admin/messages/sent')}}"><i class="fa fa-envelope-o"></i>Send Mail</a>
                                        </li>
