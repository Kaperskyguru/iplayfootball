                    ...
                    <div class="panel-body">
                        <form class="col-sm-6" method="POST" action="{{ url('admin/scouts') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="name" name="name" placeholder="Enter scout Name" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-check">
                                ...
                                <div class="reset-button">
                                    <input type="text" class="hidden" id="role" value="7" name="role" required>
                                    <input type="hidden" class="hidden" id="type" value="scout" name="type" required>
