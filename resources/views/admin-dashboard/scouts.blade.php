                    ...
                    <div class="table-responsive">
                        <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="{{ asset(extractFromImage($scout->scout_image_id)) }}" class="img-circle" alt="User Image"
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-add btn-sm" id="updateScout" data-id="{{$scout->id}}" data-token="{{ csrf_token() }}"
                                            data-toggle="modal" data-target="#customer1"><i class="fa fa-pencil"></i></button>
                                        <button type="button" id="deleteScout" data-id="{{$scout->id}}" data-token="{{ csrf_token() }}" class="btn btn-danger btn-sm"
    ...
    $(document).ready(function(){
        ...
        function newElement() {
            ...
            if (inputValue === '') {
               ...
               addPlayer(inputValue, scoutId, token);  
            }
            removeSelOption(inputValue)   
        }

        function addPlayer(playerID, scoutID, token){
            $.ajax({
                url:'/admin/scouts/associate',
                type:'post',
                data:{'player':playerID, 'id':scoutID, '_token': token},
                success: function(data) {
