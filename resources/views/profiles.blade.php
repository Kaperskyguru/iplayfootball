                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <table class="table table-striped">
                                                                <thead>
                                                                    <tr>
                                                                        <th scope="col" style="color:forestgreen">Rapael Vareane
                                                                        </th>
                                                                ...
                                                                <div class="col-12 card" style="width:18rem">
                                                                    ...
                                                                    <div class="col-12 card-body">
                                                                        <div class="row">
                                                                            ...
                                                                            <button type="button" class="btn btn-danger mx-auto" data-toggle="modal" href="#exampleModalCenter1">
                                                                                See More...
                                                                            </button>
                                                                            <div class="modal fade mt-5" id="exampleModalCenter1" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                                                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-header">
                                                                                            <h5 class="modal-title text-left" id="exampleModalCenterTitle" style="color:black;">Player Info
                                                                                        ...
                                                                                        <div class="col-12 card" style="width:18rem">
                                                                                            ...
                                                                                            <div class="col-12 card-body">
                                                                                                <div class="row">
                                                                                                    ...
                                                                                                    <button type="button" class="btn btn-danger mx-auto" data-toggle="modal" href="#exampleModalCenter2">
                                                                                                        See More...
                                                                                                    </button>
