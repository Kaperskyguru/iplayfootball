                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-12 banner-text">
                        <div class="row">
                            ...
                            <h2 class="col-12 text-center" style="text-shadow: 2px 2px 4px #000000">...want to request for a player<br> make an enquiry or just want to talk...<br> ... the options below are a good way to get started.</h2>
                        </div>
                    </div>
                </div>
                <!-- banner text -->
