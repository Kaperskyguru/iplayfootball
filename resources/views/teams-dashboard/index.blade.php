        ...
        <div class="col-sm-12 col-md-4">
            <div class="card">
                <div class="card-header">
                    <img src="{{ asset(extractFromImage($team->image_id)) }}" class="card-header-headshot" alt="User Image">
                </div>
                <div class="card-content">
                    <div class="card-content-member text-center">
                    <h4 class="m-t-0">{{ $team->name ?: 'Nill'}}</h4>
                    ...
                    <div class="card-footer">
                        <div class="card-footer-stats">
                            ...
                            <span>{{ $team->status->status_text}}</span>
                            </div>
                            <div>
                                <p>MESSAGES:</p>
                        ...
                        <div class="card-footer-message">
                            ...
                            <a href="#customer1" data-id="{{$user->id}}" data-token="<?php echo csrf_token() ?>" id="updateTeam" data-toggle="modal" data-target="">
                                <h4>
            ...
            <div class="col-sm-12 col-md-8">
                <div class="row">
                    ...
                    @else
                    @if ($team->verify->status->status_text == 'Pending')
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div id="cardbox4">
                                    <div class="statistic-box">
                                        <i class="fa fa-check-square-o fa-3x"></i>
                                        <div class="counter-number pull-right">
                                        <span class="count-number">{{ $team->verify->status->status_text }}</span>
                                            <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                                            </span>
                                        </div>
                                        <h3> Account Verification</h3>
                                    ...
                                    <form class="form-horizontal" method="POST" action="{{ url('/team/verify') }}" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <div class="col-md-12 form-group user-form-group">
                                                <input type="text" value="team" id="accountType" name="accountType" class="hidden">
                                                <input type="number" value="{{Auth::user()->team->id}}" id="userID" name="userID" class="hidden">
