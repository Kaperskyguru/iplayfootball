        ...
        <div class="col-sm-12 col-md-4">
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <h4 class="m-t-0">{{ $user->player->player_name ?: 'Nill'}}</h4>
                    ...
                    <div class="card-content-summary">
                        <p> {{$player->player_biography ?: 'Nill'}} </p>
                        </div>
                    </div>
                    <div class="card-footer">
                        ...
                        <div class="card-footer-message">
                            ...
                            <a href="#customer1" data-id="{{$user->id}}" data-token="<?php echo csrf_token() ?>" id="updatePlayer" data-toggle="modal" data-target="">
                                <h4>
            ...
            <div class="col-sm-12 col-md-8">
                <div class="row">
                    ...
                    @else
                    @if ($player->verify->status->status_text == 'Pending')
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div id="cardbox4">
                                    <div class="statistic-box">
                                        <i class="fa fa-check-square-o fa-3x"></i>
                                        <div class="counter-number pull-right">
                                        <span class="count-number">{{ $player->verify->status->status_text }}</span>
                                            <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                                            </span>
                                        </div>
                                        <h3> Account Verification</h3>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <form class="form-horizontal" method="POST" action="{{ url('/player/verify') }}" enctype="multipart/form-data">
                                        <fieldset>
                                            @csrf
                                            <!-- Text input-->
                                            ...
                                            <div class="col-md-12 form-group user-form-group">
                                                <input type="text" value="player" id="accountType" name="accountType" class="hidden">
                                                <input type="number" value="{{Auth::user()->player->id}}" id="userID" name="userID" class="hidden">
