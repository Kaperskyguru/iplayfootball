                                                                    ...
                                                                    <div class="table-responsive">
                                                                        <table id="dataTableExample1" class="table table-bordered table-striped table-hover">
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td><img src="{{asset(extractFromImage($player->player_image_id))}}" class="img-circle" alt="User Image" width="50" height="50"> </td>
                                                                                    ...
                                                                                    {{-- <td>
                                                                                        <button type="button" data-id="{{$player->id}}" class="btn btn-add btn-sm" data-token="" data-toggle="modal" id="updatePlayer" data-target="#updateModal"><i class="fa fa-pencil"></i></button>
                                                                                        <button type="button" data-id="{{$player->id}}" id="deletePlayer" data-token="" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#customer2"><i class="fa fa-trash-o"></i> </button>
                                                                                    </td> --}}
                                                                                </tr>
                                                                                @endforeach
