                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 p-0 inbox-mail">
                            ...
                            @foreach($Messages as $message)
                                <a href="{{url('/scout/details/'.$message->id)}}" class="inbox_item unread">
                                    <div class="inbox-avatar">
                                        <img src="{{asset('public/players_assets/dist/img/avatar.png')}}" class="border-green hidden-xs hidden-sm" alt="">
