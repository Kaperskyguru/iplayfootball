                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-8">
                            <div class="inbox-toolbar btn-toolbar">
                                <div class="btn-group">
                                    <a href="{{url('/scout/messages')}}" class="btn btn-default">
                                        <span class="fa fa-long-arrow-left"></span>
                                    </a>
                                </div>
                                <div class="btn-group">
                                    <a href="{{url('/scout/compose')}}" class="btn btn-add">
                    ...
                    <div class="row m-0">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-9 p-0 inbox-mail">
                            <div class="inbox-avatar p-20 border-btm">
                                <img src="{{asset('public/players_assets/dist/img/avatar5.png')}}" class="border-green hidden-xs hidden-sm" alt="">
                                ...
                                <div class="row">
                                    <div class="m-t-20 border-all p-20">
                                        <p class="p-b-20">click here to
                                            <a href="#">Reply</a> or
                                            <a href="{{url('/scout/compose')}}">Forward</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
