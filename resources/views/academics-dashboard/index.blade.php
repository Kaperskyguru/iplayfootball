        ...
        <div class="col-sm-12 col-md-4">
            <div class="card">
                <div class="card-header">
                    <img src="{{ asset(extractFromImage($academy->academic_image_id)) }}" class="card-header-headshot" alt="User Image">
                </div>
                <div class="card-content">
                    <div class="card-content-member text-center">
                    <h4 class="m-t-0">{{ $academy->academic_name ?: 'Nill'}}</h4>
                    ...
                    <div class="card-footer">
                        <div class="card-footer-stats">
                            ...
                            <span>{{ $academy->status->status_text}}</span>
                            </div>
                            <div>
                                <p>MESSAGES:</p>
            ...
            <div class="col-sm-12 col-md-8">
                <div class="row">
                    ...
                    @else
                    @if ($academy->verify->status->status_text == 'Pending')
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                <div id="cardbox4">
                                    <div class="statistic-box">
                                        <i class="fa fa-check-square-o fa-3x"></i>
                                        <div class="counter-number pull-right">
                                        <span class="count-number">{{ $academy->verify->status->status_text }}</span>
                                            <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                                            </span>
                                        </div>
                                        <h3> Account Verification</h3>
                                    ...
                                    <form class="form-horizontal" method="POST" action="{{ url('/academic/verify') }}" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <option value="15">Silvacademic_er ₦2,000</option>
                                            </select>
                                            </div>
                                            <div class="col-md-6 form-group">
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="number" idacademic_="IDNumber" name="IDNumber" placeholder="unique driver's licence number" class="form-control">
                                            </div>
                                            <div class="col-md-6 form-group">
                                            ...
                                            <div class="col-md-6 form-academic_group">
                                                <label>Picture upload</label>
                                                <input type="file" name="secondFile">
                                                <input type="hidden" name="old_picture">
                                            </div>
                                            <div class="col-md-12 form-group user-form-group">
                                                <input type="text" value="academy" id="accountType" name="accountType" class="hidden">
